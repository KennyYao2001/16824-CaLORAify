...
@registry.register_builder("cal_data")
class CalDataBuilder(BaseDatasetBuilder):
    train_dataset_cls = CALVQADataset
    eval_dataset_cls = CALVQADataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cal/default.yaml",
    }
